...
class SaveTheMarriageDate extends StatefulWidget {
  const SaveTheMarriageDate({Key? key}) : super(key: key);

  @override
  _SaveTheMarriageDateState createState() => _SaveTheMarriageDateState();
}

class _SaveTheMarriageDateState extends State<SaveTheMarriageDate> {
  EdgeInsetsGeometry margin = EdgeInsets.only(bottom: screenHeight! * 0.095);
