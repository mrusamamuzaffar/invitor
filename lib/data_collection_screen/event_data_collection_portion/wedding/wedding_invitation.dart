...
class WeddingInvitation extends StatefulWidget {
   const WeddingInvitation({Key? key}) : super(key: key);

  @override
  State<WeddingInvitation> createState() => _WeddingInvitationState();
}

class _WeddingInvitationState extends State<WeddingInvitation> with DataCollectionBehavior {
    ...
    return Column(
      ...
      children: [
        Selector<
            ...
            double?>(shouldRebuild: (previous, next) => previous != next, selector: (context, dataCollectionScreenChangeNotifier) =>
          dataCollectionScreenChangeNotifier.textFieldChangeNotifierMap[hintTextList[0]],
