...
class WeddingEngagementPartyThree extends StatelessWidget {
  const WeddingEngagementPartyThree({Key? key}) : super(key: key);
      ...
      children: [
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[0],maintainState: true, maintainSize: true, maintainAnimation: true, child: Container(alignment: Alignment.centerLeft, padding: const EdgeInsets.only(left: 32.0), child: invitationCardSingleTextContainer(text: '${selectedContactList[0].name}$formalInvitationHeaderTextPartOne${selectedContactList[0].isWithFamily ? withYourFamilyTextFormat : ''}$formalInvitationHeaderTextPartTwo', animationTextNumber: containerIndexAnimationNumber[0], myContainerIndex: 0)));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[1], maintainState: true, maintainSize: true, maintainAnimation: true, child: Container(alignment: Alignment.center, padding: const EdgeInsets.only(right: 88.0), child: invitationCardSingleTextContainer(text: textFieldDataMap[hintTextList[0]]!, animationTextNumber: containerIndexAnimationNumber[1], myContainerIndex: 1)));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[3], maintainState: true, maintainSize: true, maintainAnimation: true, child: Container(alignment: Alignment.center, padding: const EdgeInsets.only(left: 56.0), child: invitationCardSingleTextContainer(text: textFieldDataMap[hintTextList[1]]!, animationTextNumber: containerIndexAnimationNumber[3], myContainerIndex: 3)));
            }),
