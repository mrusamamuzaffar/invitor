...
class WeddingEngagementPartyTwo extends StatelessWidget {
  const WeddingEngagementPartyTwo({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    formalInvitationHeaderTextPartTwo = 'for an engagement party\nin honor of';
