...
class WeddingEngagementPartyOne extends StatelessWidget {
  const WeddingEngagementPartyOne({Key? key}) : super(key: key);
      ...
      children: [
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[0],maintainState: true, maintainSize: true, maintainAnimation: true, child: Container(alignment: Alignment.centerLeft, padding: const EdgeInsets.only(left: 16.0), child: invitationCardSingleTextContainer(text: '${selectedContactList[0].name}$formalInvitationHeaderTextPartOne${selectedContactList[0].isWithFamily ? withYourFamilyTextFormat : ''}$formalInvitationHeaderTextPartTwo', animationTextNumber: containerIndexAnimationNumber[0], myContainerIndex: 0)));
            }),
