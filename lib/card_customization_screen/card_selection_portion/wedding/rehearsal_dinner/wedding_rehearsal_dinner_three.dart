...
class WeddingRehearsalDinnerThree extends StatelessWidget {
  const WeddingRehearsalDinnerThree({Key? key}) : super(key: key);
      ...
      children: [
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[2], maintainState: true, maintainSize: true, maintainAnimation: true,child: SizedBox(width: 0, height: 0, child: invitationCardSingleTextContainer(text: '+', animationTextNumber: containerIndexAnimationNumber[2], myContainerIndex: 2)));
            }),
