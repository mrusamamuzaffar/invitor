...
class WeddingBachelorPartyFour extends StatelessWidget {
  const WeddingBachelorPartyFour({Key? key}) : super(key: key);
      ...
      children: [
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[0],maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'BACHELOR\nPARTY', animationTextNumber: containerIndexAnimationNumber[0], myContainerIndex: 0));
            }),
