...
class WeddingWeddingInvitationsOne extends StatelessWidget {
  const WeddingWeddingInvitationsOne({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    formalInvitationHeaderTextPartTwo = 'for the\nwedding of';
