...
class WeddingWeddingInvitationsTen extends StatelessWidget {
  const WeddingWeddingInvitationsTen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    formalInvitationHeaderTextPartTwo = 'for the wedding of';
