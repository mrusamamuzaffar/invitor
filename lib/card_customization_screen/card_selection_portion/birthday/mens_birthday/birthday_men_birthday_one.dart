...
class BirthdayMensBirthdayOne extends StatelessWidget {
  const BirthdayMensBirthdayOne({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[2], maintainState: true, maintainSize: true, maintainAnimation: true,child: invitationCardSingleTextContainer(text: 'birthday party!\nfor'.toUpperCase(), animationTextNumber: containerIndexAnimationNumber[2], myContainerIndex: 2));
              }),
