...
class BirthdayFirstBirthdayTwo extends StatelessWidget {
  const BirthdayFirstBirthdayTwo({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    formalInvitationHeaderTextPartTwo = ' for a\n 1st birthday party';
      ...
      children: [
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[2], maintainState: true, maintainSize: true, maintainAnimation: true,child: invitationCardSingleTextContainer(text: '${textFieldDataMap[hintTextList[0]]!} is turning'.toUpperCase(), animationTextNumber: containerIndexAnimationNumber[2], myContainerIndex: 2));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[3], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'ONE', animationTextNumber: containerIndexAnimationNumber[3], myContainerIndex: 3));
            }),
