...
class BirthdayFirstBirthdayOne extends StatelessWidget {
  const BirthdayFirstBirthdayOne({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[3], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: '1ST BIRTHDAY', animationTextNumber: containerIndexAnimationNumber[3], myContainerIndex: 3));
              }),
