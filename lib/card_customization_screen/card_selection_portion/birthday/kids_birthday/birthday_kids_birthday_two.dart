...
class BirthdayKidsBirthdayTwo extends StatelessWidget {
  const BirthdayKidsBirthdayTwo({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    formalInvitationHeaderTextPartTwo = 'to celebrate';
