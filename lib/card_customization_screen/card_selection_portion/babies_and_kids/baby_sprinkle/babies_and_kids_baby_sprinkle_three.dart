...
class BabiesAndKidsBabySprinkleThree extends StatelessWidget {
  const BabiesAndKidsBabySprinkleThree({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    containerIndexAnimationNumber = [0,2,2,2,1,0];
      ...
      children: [
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[1], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'It\'s a baby', animationTextNumber: containerIndexAnimationNumber[1], myContainerIndex: 1));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[2], maintainState: true, maintainSize: true, maintainAnimation: true,child: invitationCardSingleTextContainer(text: 'SPRINKLE', animationTextNumber: containerIndexAnimationNumber[2], myContainerIndex: 2));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[3], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'in honor of', animationTextNumber: containerIndexAnimationNumber[3], myContainerIndex: 3));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[4], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: ' ${textFieldDataMap[hintTextList[0]]}'.toUpperCase(), animationTextNumber: containerIndexAnimationNumber[4], myContainerIndex: 4));
            }),
