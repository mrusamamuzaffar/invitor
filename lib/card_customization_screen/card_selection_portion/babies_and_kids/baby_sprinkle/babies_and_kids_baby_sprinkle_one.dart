...
class BabiesAndKidsBabySprinkleOne extends StatelessWidget {
  const BabiesAndKidsBabySprinkleOne({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    formalInvitationHeaderTextPartOne = ' PLEASE JOIN US FOR';
