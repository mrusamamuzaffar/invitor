...
class BabiesAndKidsBabyShowerOne extends StatelessWidget {
  const BabiesAndKidsBabyShowerOne({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[3], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: '${textFieldDataMap[hintTextList[2]]}', animationTextNumber: containerIndexAnimationNumber[3], myContainerIndex: 3));
              }),
