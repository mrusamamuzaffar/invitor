...
class BabiesAndKidsBabyShowerThree extends StatelessWidget {
  const BabiesAndKidsBabyShowerThree({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[4], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'RSVP at ${textFieldDataMap[hintTextList[4]]}', animationTextNumber: containerIndexAnimationNumber[4], myContainerIndex: 4));
              }),
