...
class BabiesAndKidsFirstBirthdayTwo extends StatelessWidget {
  const BabiesAndKidsFirstBirthdayTwo({Key? key}) : super(key: key);
      ...
      children: [
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[0],maintainState: true, maintainSize: true, maintainAnimation: true, child: Container(alignment: Alignment.centerRight, child: invitationCardSingleTextContainer(text: selectedContactList[0].name, animationTextNumber: containerIndexAnimationNumber[0], myContainerIndex: 0)));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[1], maintainState: true, maintainSize: true, maintainAnimation: true, child: Container(alignment: Alignment.centerRight, child: invitationCardSingleTextContainer(text: 'join us as', animationTextNumber: containerIndexAnimationNumber[1], myContainerIndex: 1)));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[2], maintainState: true, maintainSize: true, maintainAnimation: true,child: Container(alignment: Alignment.centerRight, child: invitationCardSingleTextContainer(text: textFieldDataMap[hintTextList[0]]!, animationTextNumber: containerIndexAnimationNumber[2], myContainerIndex: 2)));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[3], maintainState: true, maintainSize: true, maintainAnimation: true, child: Container(alignment: Alignment.centerRight, child: invitationCardSingleTextContainer(text: 'is turning one', animationTextNumber: containerIndexAnimationNumber[3], myContainerIndex: 3)));
            }),
