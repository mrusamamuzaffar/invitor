...
class BabiesAndKidsSipAndSeeThree extends StatelessWidget {
  const BabiesAndKidsSipAndSeeThree({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[0],maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'Welcome\nLittle One', animationTextNumber: containerIndexAnimationNumber[0], myContainerIndex: 0));
              }),
