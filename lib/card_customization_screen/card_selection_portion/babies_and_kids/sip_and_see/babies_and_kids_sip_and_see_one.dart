...
class BabiesAndKidsSipAndSeeOne extends StatelessWidget {
  const BabiesAndKidsSipAndSeeOne({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[1], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: '${selectedContactList[0].name} you are invited to', animationTextNumber: containerIndexAnimationNumber[1], myContainerIndex: 1));
              }),
