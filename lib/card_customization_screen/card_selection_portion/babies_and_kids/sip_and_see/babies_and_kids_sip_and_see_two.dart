...
class BabiesAndKidsSipAndSeeTwo extends StatelessWidget {
  const BabiesAndKidsSipAndSeeTwo({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    containerIndexAnimationNumber = [0,2,2,1,2,0];
      ...
      children: [
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[0],maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'SIP & SEE', animationTextNumber: containerIndexAnimationNumber[0], myContainerIndex: 0));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[1], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: '${selectedContactList[0].name}\nyou are invited to'.toUpperCase(), animationTextNumber: containerIndexAnimationNumber[1], myContainerIndex: 1));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[2], maintainState: true, maintainSize: true, maintainAnimation: true,child: invitationCardSingleTextContainer(text: 'MEET SWEET BABY', animationTextNumber: containerIndexAnimationNumber[2], myContainerIndex: 2));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[3], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: ' ${textFieldDataMap[hintTextList[0]]}'.toUpperCase(), animationTextNumber: containerIndexAnimationNumber[3], myContainerIndex: 3));
            }),
