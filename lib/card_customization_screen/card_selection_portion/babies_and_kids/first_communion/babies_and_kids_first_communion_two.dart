...
class BabiesAndKidsFirstCommunionTwo extends StatelessWidget {
  const BabiesAndKidsFirstCommunionTwo({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[0],maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: '${selectedContactList[0].name} please join us\nas our sweet ${(textFieldDataMap[hintTextList[1]]) == 'Baby boy' ? 'son' : 'daughter'}', animationTextNumber: containerIndexAnimationNumber[0], myContainerIndex: 0));
              }),
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[2], maintainState: true, maintainSize: true, maintainAnimation: true,child: invitationCardSingleTextContainer(text: 'will receive her', animationTextNumber: containerIndexAnimationNumber[2], myContainerIndex: 2));
              }),
