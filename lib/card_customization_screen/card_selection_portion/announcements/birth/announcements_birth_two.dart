...
class AnnouncementsBirthTwo extends StatelessWidget {
  const AnnouncementsBirthTwo({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    initMyAnimatedTextChildObjectMap(context, selectedContactList[0].name);
      ...
      children: [
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[0],maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'Welcome', animationTextNumber: containerIndexAnimationNumber[0], myContainerIndex: 0));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[1], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: textFieldDataMap[hintTextList[1]]!.toUpperCase(), animationTextNumber: containerIndexAnimationNumber[1], myContainerIndex: 1));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[2], maintainState: true, maintainSize: true, maintainAnimation: true,child: invitationCardSingleTextContainer(text: textFieldDataMap[hintTextList[0]]!.toUpperCase(), animationTextNumber: containerIndexAnimationNumber[2], myContainerIndex: 2));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[3], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'BORN ${DateFormat('EEEE').format(pickedDate!)},\n${pickedDate.getMonthName(monthNumber: pickedDate!.month)} ${appendDateSuffix(date: int.parse(DateFormat('d').format(pickedDate!)))}, ${(DateFormat('yyyy').format(pickedDate!))}'.toUpperCase(), animationTextNumber: containerIndexAnimationNumber[3], myContainerIndex: 3));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[4], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'at ${pickedTime!.format(context)}'.toUpperCase(), animationTextNumber: containerIndexAnimationNumber[4], myContainerIndex: 4));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[5], maintainState: true, maintainSize: true, maintainAnimation: true, child: SizedBox(width: 0, height: 0, child: invitationCardSingleTextContainer(text: '', animationTextNumber: containerIndexAnimationNumber[5], myContainerIndex: 5)));
            }),
