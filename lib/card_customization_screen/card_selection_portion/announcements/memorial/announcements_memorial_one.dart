...
class AnnouncementsMemorialOne extends StatelessWidget {
  const AnnouncementsMemorialOne({Key? key}) : super(key: key);
      ...
      children: [
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[0],maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'IN LOVING MEMORY OF', animationTextNumber: containerIndexAnimationNumber[0], myContainerIndex: 0));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[3], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'memorial service will be at\n${textFieldDataMap[hintTextList[2]]!}'.toUpperCase(), animationTextNumber: containerIndexAnimationNumber[3], myContainerIndex: 3));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[5], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'at ${pickedTime!.format(context)}', animationTextNumber: containerIndexAnimationNumber[5], myContainerIndex: 5));
            }),
