...
class AnnouncementsSaveTheDateTwo extends StatelessWidget {
  const AnnouncementsSaveTheDateTwo({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[2], maintainState: true, maintainSize: true, maintainAnimation: true,child: invitationCardSingleTextContainer(text: '- A N D -', animationTextNumber: containerIndexAnimationNumber[2], myContainerIndex: 2));
              }),
