...
class AnnouncementsMovingTwo extends StatelessWidget {
  const AnnouncementsMovingTwo({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[0],maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'WE HAVE MOVED!', animationTextNumber: containerIndexAnimationNumber[0], myContainerIndex: 0));
              }),
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[1], maintainState: true, maintainSize: true, maintainAnimation: true, child: SizedBox(width: 0, height: 0, child: invitationCardSingleTextContainer(text: '', animationTextNumber: containerIndexAnimationNumber[1], myContainerIndex: 1)));
              }),
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[3], maintainState: true, maintainSize: true, maintainAnimation: true, child: SizedBox(width: 0, height: 0, child: invitationCardSingleTextContainer(text: '', animationTextNumber: containerIndexAnimationNumber[3], myContainerIndex: 3)));
              }),
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[4], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: reformatAddress(address: textFieldDataMap[hintTextList[0]]!).toUpperCase(), animationTextNumber: containerIndexAnimationNumber[4], myContainerIndex: 4));
              }),
