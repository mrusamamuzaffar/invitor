...
class AnnouncementsWeddingThree extends StatelessWidget {
  const AnnouncementsWeddingThree({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[4], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'are pleased to announce\ntheir marriage', animationTextNumber: containerIndexAnimationNumber[4], myContainerIndex: 4));
              }),
