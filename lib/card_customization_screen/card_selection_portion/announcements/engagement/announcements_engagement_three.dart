...
class AnnouncementsEngagementThree extends StatelessWidget {
  const AnnouncementsEngagementThree({Key? key}) : super(key: key);
      ...
      children: [
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[0],maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'We\'re\nEngaged!', animationTextNumber: containerIndexAnimationNumber[0], myContainerIndex: 0));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[5], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: pickedTime!.format(context).toUpperCase(), animationTextNumber: containerIndexAnimationNumber[5], myContainerIndex: 5));
            }),
