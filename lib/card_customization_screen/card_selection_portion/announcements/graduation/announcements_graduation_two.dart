...
class AnnouncementsGraduationTwo extends StatelessWidget {
  const AnnouncementsGraduationTwo({Key? key}) : super(key: key);
      ...
      children: [
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[2], maintainState: true, maintainSize: true, maintainAnimation: true,child: invitationCardSingleTextContainer(text: textFieldDataMap[hintTextList[2]]!.toUpperCase(), animationTextNumber: containerIndexAnimationNumber[2], myContainerIndex: 2));
            }),
