...
class AnnouncementsGraduationThree extends StatelessWidget {
  const AnnouncementsGraduationThree({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    containerIndexAnimationNumber = [0,1,2,2,2,0];
      ...
      children: [
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[0],maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'CONGRATS\nto our graduate', animationTextNumber: containerIndexAnimationNumber[0], myContainerIndex: 0));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[2], maintainState: true, maintainSize: true, maintainAnimation: true,child: invitationCardSingleTextContainer(text: textFieldDataMap[hintTextList[1]]!.toUpperCase(), animationTextNumber: containerIndexAnimationNumber[2], myContainerIndex: 2));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[4], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: textFieldDataMap[hintTextList[2]]!.toUpperCase(), animationTextNumber: containerIndexAnimationNumber[4], myContainerIndex: 4));
            }),
