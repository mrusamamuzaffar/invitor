...
class PartyHappyNewYearTwo extends StatelessWidget {
  const PartyHappyNewYearTwo({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[1], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'NEW YEARS EVE', animationTextNumber: containerIndexAnimationNumber[1], myContainerIndex: 1));
              }),
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[2], maintainState: true, maintainSize: true, maintainAnimation: true,child: invitationCardSingleTextContainer(text: 'Dinner & Dancing', animationTextNumber: containerIndexAnimationNumber[2], myContainerIndex: 2));
              }),
