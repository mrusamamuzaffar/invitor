...
class PartySummerAndPoolThree extends StatelessWidget {
  const PartySummerAndPoolThree({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    formalInvitationHeaderTextPartOne = 'join us for pool party';
      ...
      children: [
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[2], maintainState: true, maintainSize: true, maintainAnimation: true,child: invitationCardSingleTextContainer(text: 'Get cool in the pool!', animationTextNumber: containerIndexAnimationNumber[2], myContainerIndex: 2));
            }),
