...
class PartyDinnerPartyFive extends StatelessWidget {
  const PartyDinnerPartyFive({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    formalInvitationHeaderTextPartOne = 'you are cordially invited to a';
