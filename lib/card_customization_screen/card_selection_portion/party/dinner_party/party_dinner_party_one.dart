...
class PartyDinnerPartyOne extends StatelessWidget {
  const PartyDinnerPartyOne({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    formalInvitationHeaderTextPartOne = 'please join us for a';
