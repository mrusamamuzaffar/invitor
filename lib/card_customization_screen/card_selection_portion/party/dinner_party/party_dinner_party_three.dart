...
class PartyDinnerPartyThree extends StatelessWidget {
  const PartyDinnerPartyThree({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    formalInvitationHeaderTextPartOne = 'join us for an evening of\ncasual cuisine\nand conversation';
