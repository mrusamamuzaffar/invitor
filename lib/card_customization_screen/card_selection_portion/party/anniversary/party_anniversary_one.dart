...
class PartyAnniversaryOne extends StatelessWidget {
  const PartyAnniversaryOne({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[1], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: '${textFieldDataMap[hintTextList[2]]!} of', animationTextNumber: containerIndexAnimationNumber[1], myContainerIndex: 1));
              }),
