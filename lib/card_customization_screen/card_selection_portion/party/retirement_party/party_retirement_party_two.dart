...
class PartyRetirementPartyTwo extends StatelessWidget {
  const PartyRetirementPartyTwo({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[3], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'Retirement', animationTextNumber: containerIndexAnimationNumber[3], myContainerIndex: 3));
              }),
