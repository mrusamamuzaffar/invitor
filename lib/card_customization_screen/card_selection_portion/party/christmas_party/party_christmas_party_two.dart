...
class PartyChristmasPartyTwo extends StatelessWidget {
  const PartyChristmasPartyTwo({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    formalInvitationHeaderTextPartOne = 'join us for our annual';
      ...
      children: [
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[2], maintainState: true, maintainSize: true, maintainAnimation: true,child: invitationCardSingleTextContainer(text: 'Holiday Party', animationTextNumber: containerIndexAnimationNumber[2], myContainerIndex: 2));
            }),
