...
class PartyChristmasPartyThree extends StatelessWidget {
  const PartyChristmasPartyThree({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[2], maintainState: true, maintainSize: true, maintainAnimation: true,child: invitationCardSingleTextContainer(text: 'Gift\nexchange\n& Holiday party', animationTextNumber: containerIndexAnimationNumber[2], myContainerIndex: 2));
              }),
