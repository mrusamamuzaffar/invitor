...
class PartySleepoverPartyOne extends StatelessWidget {
  const PartySleepoverPartyOne({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    formalInvitationHeaderTextPartOne = 'THERE\'S GOING TO BE SPRINKLY SPARKLY\nSHIMMERING FUN!\n\nyou\'re invited to';
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[2], maintainState: true, maintainSize: true, maintainAnimation: true,child: invitationCardSingleTextContainer(text: 'Sleepover Party', animationTextNumber: containerIndexAnimationNumber[2], myContainerIndex: 2));
              }),
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[3], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'by ${textFieldDataMap[hintTextList[0]]!}', animationTextNumber: containerIndexAnimationNumber[3], myContainerIndex: 3));
              }),
