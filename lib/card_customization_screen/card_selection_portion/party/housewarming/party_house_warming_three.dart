...
class PartyHousewarmingThree extends StatelessWidget {
  const PartyHousewarmingThree({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    formalInvitationHeaderTextPartOne = 'you are invited to a';
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[2], maintainState: true, maintainSize: true, maintainAnimation: true,child: invitationCardSingleTextContainer(text: 'HOUSEWARMING', animationTextNumber: containerIndexAnimationNumber[2], myContainerIndex: 2));
              }),
