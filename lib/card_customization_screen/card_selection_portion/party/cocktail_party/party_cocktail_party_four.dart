...
class PartyCocktailPartyFour extends StatelessWidget {
  const PartyCocktailPartyFour({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    formalInvitationHeaderTextPartOne = 'you are warmly invited to a';
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[2], maintainState: true, maintainSize: true, maintainAnimation: true,child: invitationCardSingleTextContainer(text: 'Cocktail Party', animationTextNumber: containerIndexAnimationNumber[2], myContainerIndex: 2));
              }),
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[3], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'hosted by\n${textFieldDataMap[hintTextList[0]]!}'.toUpperCase(), animationTextNumber: containerIndexAnimationNumber[3], myContainerIndex: 3));
              }),
