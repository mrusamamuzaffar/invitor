...
class PartyGraduationPartyTwo extends StatelessWidget {
  const PartyGraduationPartyTwo({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[1], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'G R A D U A T I O N  P A R T Y', animationTextNumber: containerIndexAnimationNumber[1], myContainerIndex: 1));
              }),
