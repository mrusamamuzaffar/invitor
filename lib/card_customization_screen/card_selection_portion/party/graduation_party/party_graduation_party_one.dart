...
class PartyGraduationPartyOne extends StatelessWidget {
  const PartyGraduationPartyOne({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[1], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'Graduation Party', animationTextNumber: containerIndexAnimationNumber[1], myContainerIndex: 1));
              }),
