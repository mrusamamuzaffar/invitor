...
class PartyGraduationPartyThree extends StatelessWidget {
  const PartyGraduationPartyThree({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[1], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'GRADUATION\nPARTY', animationTextNumber: containerIndexAnimationNumber[1], myContainerIndex: 1));
              }),
