...
class PartyBBQPartyOne extends StatelessWidget {
  const PartyBBQPartyOne({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[2], maintainState: true, maintainSize: true, maintainAnimation: true,child: invitationCardSingleTextContainer(text: 'HAPPINESS IS A SUMMER', animationTextNumber: containerIndexAnimationNumber[2], myContainerIndex: 2));
              }),
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[3], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: 'BBQ', animationTextNumber: containerIndexAnimationNumber[3], myContainerIndex: 3));
              }),
