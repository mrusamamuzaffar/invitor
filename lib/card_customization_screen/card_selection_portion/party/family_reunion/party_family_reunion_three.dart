...
class PartyFamilyReunionThree extends StatelessWidget {
  const PartyFamilyReunionThree({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    formalInvitationHeaderTextPartOne = 'join us for the';
